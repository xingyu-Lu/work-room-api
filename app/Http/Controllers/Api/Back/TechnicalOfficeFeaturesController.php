...
class TechnicalOfficeFeaturesController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $news = TechnicalOfficeFeature::where($where)->orderBy('id', 'desc')->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        TechnicalOfficeFeature::create($params);
    ...
    {
        $dynamic = TechnicalOfficeFeature::find($id);
    ...
    public function status(Request $request)
    {
        ...
        TechnicalOfficeFeature::updateOrCreate(['id' => $id], ['status' => $status]);
